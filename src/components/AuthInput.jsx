...
export const InputCard = ({label, placeholder, name, type, onChange }) => {
  return (
    <div className="w-4/5 bg-[#F5F8FA] my-4 px-2.5 mx-auto dark:bg-gray-700">
      ...
      <input type={type} name={name} placeholder={placeholder} className="inputDefault inputDefault:hover inputDefault:focus dark:hover:border-sky-700 dark:focus:border-sky-700 dark:placeholder-gray-500/50"
