...
import { TargetCard } from "../../../components/Card"
    ...
    <div className="px-[24px] py-[16px] border-b border-slate-200 flex flex-col">
      <div className="flex flex-row mb-[5px] items-center">
        ...
        <div className="flex flex-row items-center gap-[8px]">
          <p className="font-bold text-[16px] leading-[26px] ">dave</p>
...
const ReportList = () => {
  return(
    <div className="px-[24px] py-[16px] border-b border-slate-200 flex flex-col">
      <div className="flex flex-row mb-[5px] items-center">
        <div className="flex flex-row items-center gap-[8px]">
          <p className="font-bold text-[16px] leading-[26px] truncate">101句投資金句 來自10 位世界頂尖投資家的財富箴言</p>
          <div className="ml-2 flex  pt-2 flex-wrap sm:flex-nowrap space-x-4">
            <ul className="pl-2 font-normal list-disc text-sm text-[#6C757D]">
              <li>上傳者： Dave</li>
              <li>上傳日期： 2023/05/16</li>
            </ul>
            <ul className="font-normal list-disc text-sm text-[#6C757D]">
      ...
      <MainContainer>
        ...
        <div className="h-screen flex flex-col sm:flex-row overflow-y-auto">
          ...
          <div className="w-full">
            <div className="flex p-2 text-gray-500 border-b-4 border-slate-400/25">
              <button className="border-b-2 focus:text-black focus:border-black" autoFocus onClick={() => setCurrentTab("post")}>貼文清單</button>
              <button className="border-b-2 ml-3 focus:text-black focus:border-black" onClick={() => setCurrentTab("report")}>報告清單</button>
            </div>
            <div >
